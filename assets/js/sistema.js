$(document).ready(function() {
    ...
    $('.editar').click(function(){
        ...
        $('.resuelto'+id).html('<input style="width:100%" class="form-control resueltoIN'+id+'" value='+resuelto+'>');
        $('.aprobados'+id).html('<input style="width:100%" class="form-control aprobadosIN'+id+'" value='+aprobados+'>');
        $('.altas'+id).html('<input style="width:100%" class="form-control altasIN'+id+'" value='+altas+'>');
        $('.medias'+id).html('<input style="width:100%" class="form-control mediasIN'+id+'" value='+medias+'>');
        $('.bajas'+id).html('<input style="width:100%" class="form-control bajasIN'+id+'" value='+bajas+'>');
